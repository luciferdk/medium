    ...
    return <div>
        ...
        <div className="flex justify-center w-full pt-8">
            <div className="max-w-screen-lg w-full ">
                ...
                }} type="text" id="helper-text" className=" bg-gray-50 border border-gray-300 block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Title" />
    ...
    return <div>
        <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
                        ...
                        <button type="button" className="p-2 text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600">
                            <svg className="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 21 18">
                                <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"
                                    strokeWidth="2" d="M9.5 3h9.563M9.5 9h9.563M9.5 15h9.563M1.5 13a2 2 0 1 1 3.321 1.5L1.5 17h5m-5-15 2-1v6m-2 0h4" />
                            </svg>
            ...
            <div className="py-2 bg-gray-50 rounded-b-lg">
                ...
                <textarea onChange={onChange} id="editor" rows={8} className="focs:outline-none block w-full px-0 text-sm text-gray-800 bg-gray-50 border-0 pl-2" placeholder="Write an article..." required ></textarea>
            </div>
        </div>
